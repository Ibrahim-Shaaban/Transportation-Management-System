...
RSpec.describe "/assignments", type: :request do
  ...
  # AssignmentsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get assignments_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
      ...
      it "creates a new Assignment" do
        expect {
          post assignments_url,
               params: { assignment: valid_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "does not create a new Assignment" do
        expect {
          post assignments_url,
               params: { assignment: invalid_attributes }, as: :json
        }.to change(Assignment, :count).by(0)
      end

      it "renders a JSON response with errors for the new assignment" do
        post assignments_url,
             params: { assignment: invalid_attributes }, headers: valid_headers, as: :json
    ...
    context "with valid parameters" do
      ...
      it "updates the requested assignment" do
        ...
        patch assignment_url(assignment),
              params: { assignment: new_attributes }, headers: valid_headers, as: :json
        assignment.reload
  ...
  describe "DELETE /destroy" do
    it "destroys the requested assignment" do
      assignment = Assignment.create! valid_attributes
      expect {
        delete assignment_url(assignment), headers: valid_headers, as: :json
      }.to change(Assignment, :count).by(-1)
    end
  end
end
